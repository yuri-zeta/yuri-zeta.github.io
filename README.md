...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/sweet-heart-d352)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/sweet-heart-d352
```

A live public deployment of this template is available at [https://sweet-heart-d352.templates.workers.dev](https://sweet-heart-d352.templates.workers.dev)
